...
use Manuylenko\Telegram\Bot\Api\Entities\Bot\Menu\MenuButtonCommands;
use Manuylenko\Telegram\Bot\Api\Entities\Bot\Menu\MenuButtonDefault;
use Manuylenko\Telegram\Bot\Api\Entities\Bot\Menu\MenuButtonWebApp;
use Manuylenko\Telegram\Bot\Api\Entities\Chat;
use Manuylenko\Telegram\Bot\Api\Entities\ChatAdministratorRights;
use Manuylenko\Telegram\Bot\Api\Entities\ChatInviteLink;
use Manuylenko\Telegram\Bot\Api\Entities\ChatPermissions;
use Manuylenko\Telegram\Bot\Api\Entities\File;
use Manuylenko\Telegram\Bot\Api\Entities\Games\GameHighScore;
...
use Manuylenko\Telegram\Bot\Api\Entities\Keyboards\ForceReply;
use Manuylenko\Telegram\Bot\Api\Entities\Keyboards\InlineKeyboardMarkup;
use Manuylenko\Telegram\Bot\Api\Entities\Keyboards\ReplyKeyboardMarkup;
use Manuylenko\Telegram\Bot\Api\Entities\Keyboards\ReplyKeyboardRemove;
use Manuylenko\Telegram\Bot\Api\Entities\Media\InputMedia;
use Manuylenko\Telegram\Bot\Api\Entities\Media\InputMediaAudio;
use Manuylenko\Telegram\Bot\Api\Entities\Media\InputMediaDocument;
use Manuylenko\Telegram\Bot\Api\Entities\Media\InputMediaPhoto;
use Manuylenko\Telegram\Bot\Api\Entities\Media\InputMediaVideo;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMember;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMemberAdministrator;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMemberBanned;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMemberLeft;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMemberMember;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMemberOwner;
use Manuylenko\Telegram\Bot\Api\Entities\Members\ChatMemberRestricted;
use Manuylenko\Telegram\Bot\Api\Entities\Message;
use Manuylenko\Telegram\Bot\Api\Entities\MessageEntity;
use Manuylenko\Telegram\Bot\Api\Entities\MessageId;
...
use Manuylenko\Telegram\Bot\Api\Entities\Stickers\MaskPosition;
use Manuylenko\Telegram\Bot\Api\Entities\Stickers\StickerSet;
 ...
 * API: 6.1
 *
 * @link https://core.telegram.org/bots/api#june-20-2022
 */
class Api
{
    /**
    ...
    {
        return (new Request(self::REQUEST_URL.$this->token.'/'.$method, $data))->send()->getResult();
    }
    ...
    public function getUpdates(
        ...
        if ($allowedUpdates !== null) {
            $allowedUpdates = Utils::toJson(Utils::toArray($allowedUpdates));
        }

        return Utils::makeEntitiesArray(Update::class, $this->sendRequest('getUpdates', [
            'offset' => $offset,
    ...
    public function setWebhook(
        ...
        return (bool) $this->sendRequest('setWebhook', [
            'url' => $url,
            ...
            'secret_token' => Utils::checkStr($secretToken, 1, 256)
        ]);
    }
    ...
    public function deleteWebhook(
        ...
        return (bool) $this->sendRequest('deleteWebhook', [
            'drop_pending_updates' => $dropPendingUpdates
        ]);
    }
    ...
    {
        return new WebhookInfo($this->sendRequest('getWebhookInfo'));
    }

    /* ------------------------ Сообщения ------------------------ */

    /**
     * Возвращает экземпляр Message или булево значение.
     *
     * @param mixed $data
     *
     * @return Message|bool|null
     */
    protected function makeMessageOrBool($data)
    {
        return is_array($data) ? new Message($data) : (is_bool($data) ? $data : null);
    }
    ...
    public function copyMessage(
        ...
        return new MessageId($this->sendRequest('copyMessage', [
            'chat_id' => $chatId,
    ...
    public function sendMessage(
        ...
        return new Message($this->sendRequest('sendMessage', [
            'chat_id' => $chatId,
    ...
    public function sendAudio(
        ...
        return new Message($this->sendRequest('sendAudio', [
            'chat_id' => $chatId,
            'audio' => $audio,
            'caption' => Utils::checkStr($caption, 0, 1024),
            'parse_mode' => $parseMode,
    ...
    public function sendAnimation(
        ...
        return new Message($this->sendRequest('sendAnimation', [
            'chat_id' => $chatId,
            'animation' => $animation,
            'duration' => $duration,
            'width' => $width,
    ...
    public function sendVideo(
        ...
        return new Message($this->sendRequest('sendVideo', [
            'chat_id' => $chatId,
            'video' => $video,
            'duration' => $duration,
            'width' => $width,
    ...
    public function sendVideoNote(
        ...
        return new Message($this->sendRequest('sendVideoNote', [
            'chat_id' => $chatId,
    ...
    public function sendVoice(
        ...
        return new Message($this->sendRequest('sendVoice', [
            'chat_id' => $chatId,
            'voice' => $voice,
            'duration' => $duration,
            'caption' => Utils::checkStr($caption, 0, 1024),
    ...
    public function sendVenue(
        ...
        return new Message($this->sendRequest('sendVenue', [
            'chat_id' => $chatId,
            'latitude' => $latitude,
            'longitude' => $longitude,
            'title' => $title,
    ...
    public function sendSticker(
        ...
        return new Message($this->sendRequest('sendSticker', [
            'chat_id' => $chatId,
            'sticker' => $sticker,
            'disable_notification' => $disableNotification,
            'protect_content' => $protectContent,
    ...
    public function sendInvoice(
        ...
        return new Message($this->sendRequest('sendInvoice', [
            'chat_id' => $chatId,
    ...
    public function sendContact(
        ...
        return new Message($this->sendRequest('sendContact', [
            'chat_id' => $chatId,
    ...
    public function sendDocument(
        ...
        return new Message($this->sendRequest('sendDocument', [
            'chat_id' => $chatId,
            'document' => $document,
            'thumb' => $thumb,
            'caption' => Utils::checkStr($caption, 0, 1024),
    ...
    public function sendPhoto(
        ...
        return new Message($this->sendRequest('sendPhoto', [
            'chat_id' => $chatId,
            'photo' => $photo,
            'caption' => Utils::checkStr($caption, 0, 1024),
            'parse_mode' => $parseMode,
    ...
    public function sendGame(
        ...
        return new Message($this->sendRequest('sendGame', [
            'chat_id' => $chatId,
    ...
    public function sendDice(
        ...
        return new Message($this->sendRequest('sendDice', [
            'chat_id' => $chatId,
            'emoji' => $emoji,
            'disable_notification' => $disableNotification,
            'protect_content' => $protectContent,
    ...
    public function sendPoll(
        ...
        return new Message($this->sendRequest('sendPoll', [
            'chat_id' => $chatId,
    ...
    public function stopPoll(
        ...
        return new Poll($this->sendRequest('stopPoll', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'reply_markup' => Utils::toJsonOrNull($replyMarkup)
        ]));
    ...
    public function sendLocation(
        ...
        return new Message($this->sendRequest('sendLocation', [
            'chat_id' => $chatId,
            'latitude' => $latitude,
            'longitude' => $longitude,
    ...
    public function editMessageLiveLocation(
        ...
        return $this->makeMessageOrBool($this->sendRequest('editMessageLiveLocation', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
    ...
    /**
     * Останавливает обновление сообщения о текущем местоположении до истечения срока действия 'live_period'.
     *
    ...
    public function stopMessageLiveLocation(
        ...
        return $this->makeMessageOrBool($this->sendRequest('stopMessageLiveLocation', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'inline_message_id' => ($chatId !== null || $messageId !== null) ? null : $inlineMessageId,
            'reply_markup' => Utils::toJsonOrNull($replyMarkup)
    ...
    public function sendMediaGroup(
        ...
        return Utils::makeEntitiesArray(Message::class, $this->sendRequest('sendMediaGroup', [
            'chat_id' => $chatId,
    ...
    public function editMessageMedia(
        ...
        return $this->makeMessageOrBool($this->sendRequest('editMessageMedia', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'inline_message_id' => ($chatId !== null || $messageId !== null) ? null : $inlineMessageId,
            'media' => Utils::toJson($media),
    ...
    public function forwardMessage(
        ...
        return new Message($this->sendRequest('forwardMessage', [
            'chat_id' => $chatId,
            'from_chat_id' => $fromChatId,
            'disable_notification' => $disableNotification,
            'protect_content' => $protectContent,
    ...
    public function editMessageCaption(
        ...
        return $this->makeMessageOrBool($this->sendRequest('editMessageCaption', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'inline_message_id' => ($chatId !== null || $messageId !== null) ? null : $inlineMessageId,
            'caption' => Utils::checkStr($caption, 0, 1024),
    ...
    public function editMessageText(
        ...
        return $this->makeMessageOrBool($this->sendRequest('editMessageText', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'inline_message_id' => ($chatId !== null || $messageId !== null) ? null : $inlineMessageId,
            'text' => Utils::checkStr($text, 1, 4096, true),
    ...
    /**
     * Редактирует разметку встроенной клавиатуры сообщения.
     *
    ...
    public function editMessageReplyMarkup(
        ...
        return $this->makeMessageOrBool($this->sendRequest('editMessageReplyMarkup', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'inline_message_id' => ($chatId !== null || $messageId !== null) ? null : $inlineMessageId,
            'reply_markup' => Utils::toJsonOrNull($replyMarkup)
    ...
    public function deleteMessage(
        ...
        return (bool) $this->sendRequest('deleteMessage', [
            'chat_id' => $chatId,
            'message_id' => $messageId
        ]);
    }
    ...
    public function setChatAdministratorCustomTitle(
        ...
        return (bool) $this->sendRequest('setChatAdministratorCustomTitle', [
            'chat_id' => $chatId,
            'user_id' => $userId,
    ...
    public function promoteChatMember(
        ...
        return (bool) $this->sendRequest('promoteChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId,
            'is_anonymous' => $isAnonymous,
    ...
    public function restrictChatMember(
        ...
        return (bool) $this->sendRequest('restrictChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId,
    ...
    public function banChatMember(
        ...
        return (bool) $this->sendRequest('banChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId,
            'until_date' => $untilDate,
    ...
    public function unbanChatMember(
        ...
        return (bool) $this->sendRequest('unbanChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId,
    ...
    public function banChatSenderChat(
        ...
        return (bool) $this->sendRequest('banChatSenderChat', [
            'chat_id' => $chatId,
    ...
    public function unbanChatSenderChat(
        ...
        return (bool) $this->sendRequest('unbanChatSenderChat', [
            'chat_id' => $chatId,
            'sender_chat_id' => $senderChatId
        ]);
    }
    ...
    public function setChatTitle(
        ...
        return (bool) $this->sendRequest('setChatTitle', [
            'chat_id' => $chatId,
    ...
    public function setChatPhoto(
        ...
        return (bool) $this->sendRequest('setChatPhoto', [
            'chat_id' => $chatId,
            'photo' => $photo
        ]);
    }
    ...
    public function deleteChatPhoto(
        ...
        return (bool) $this->sendRequest('deleteChatPhoto', [
            'chat_id' => $chatId
        ]);
    }
    ...
    public function setChatDescription(
        ...
        return (bool) $this->sendRequest('setChatDescription', [
            'chat_id' => $chatId,
    ...
    public function setChatPermissions(
        ...
        return (bool) $this->sendRequest('setChatPermissions', [
            'chat_id' => $chatId,
            'permissions' => Utils::toJson($permissions)
        ]);
    }
    ...
    public function setChatMenuButton(
        ...
        return (bool) $this->sendRequest('setChatMenuButton', [
            'chat_id' => $chatId,
    ...
    public function getChatMenuButton(
        ...
        return MenuButton::getConcreteEntity($this->sendRequest('getChatMenuButton', [
            'chat_id' => $chatId
        ]));
    }
    ...
    public function pinChatMessage(
        ...
        return (bool) $this->sendRequest('pinChatMessage', [
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'disable_notification' => $disableNotification,
        ]);
    ...
    public function unpinChatMessage(
        ...
        return (bool) $this->sendRequest('unpinChatMessage', [
            'chat_id' => $chatId,
            'message_id' => $messageId
        ]);
    }
    ...
    public function unpinAllChatMessages(
        ...
        return (bool) $this->sendRequest('unpinAllChatMessages', [
            'chat_id' => $chatId
        ]);
    }
    ...
    public function getChat(
        ...
        return new Chat($this->sendRequest('getChat', [
            'chat_id' => $chatId
        ]));
    }
    ...
    public function sendChatAction(
        ...
        return (bool) $this->sendRequest('sendChatAction', [
            'chat_id' => $chatId,
            'action' => $action
        ]);
    }
    ...
    public function getChatMember(
        ...
        return ChatMember::getConcreteEntity($this->sendRequest('getChatMember', [
            'chat_id' => $chatId,
            'user_id' => $userId
        ]));
    }
    ...
    public function getChatAdministrators(
        ...
        $data = $this->sendRequest('getChatAdministrators', [
            'chat_id' => $chatId
        ]);
    ...
    public function getChatMemberCount(
        ...
        return (int) $this->sendRequest('getChatMembersCount', [
            'chat_id' => $chatId
        ]);
    }
    ...
    public function exportChatInviteLink(
        ...
        return (string) $this->sendRequest('exportChatInviteLink', [
            'chat_id' => $chatId
        ]);
    }
    ...
    public function createChatInviteLink(
        ...
        return new ChatInviteLink($this->sendRequest('createChatInviteLink', [
            'chat_id' => $chatId,
    ...
    public function editChatInviteLink(
        ...
        return new ChatInviteLink($this->sendRequest('editChatInviteLink', [
            'chat_id' => $chatId,
            'name' => Utils::checkStr($name, 0, 32),
    ...
    public function revokeChatInviteLink(
        ...
        return new ChatInviteLink($this->sendRequest('revokeChatInviteLink', [
            'chat_id' => $chatId,
            'invite_link' => $inviteLink
        ]));
    }
    ...
    public function approveChatJoinRequest(
        ...
        return (bool) $this->sendRequest('approveChatJoinRequest', [
            'chat_id' => $chatId,
            'user_id' => $userId
        ]);
    }
    ...
    public function declineChatJoinRequest(
        ...
        return (bool) $this->sendRequest('declineChatJoinRequest', [
            'chat_id' => $chatId,
            'user_id' => $userId
        ]);
    }
    ...
    public function leaveChat(
        ...
        return (bool) $this->sendRequest('leaveChat', [
            'chat_id' => $chatId
        ]);
    }
    ...
    public function createNewStickerSet(
        ...
        return (bool) $this->sendRequest('createNewStickerSet', [
            'user_id' => $userId,
    ...
    public function addStickerToSet(
        ...
        return (bool) $this->sendRequest('addStickerToSet', [
            'user_id' => $userId,
            'name' => $name,
            'png_sticker' => $pngSticker,
            'tgs_sticker' => $tgsSticker,
    ...
    public function setStickerPositionInSet(
        ...
        return (bool) $this->sendRequest('setStickerPositionInSet', [
            'sticker' => $sticker,
            'position' => $position
        ]) ;
    }
    ...
    /**
     * Устанавливает эскиз набора стикеров.
     *
    ...
    public function setStickerSetThumb(
        ...
        return (bool) $this->sendRequest('setStickerSetThumb', [
            'name' => $name,
            'user_id' => $userId,
            'thumb' => $thumb
        ]);
    ...
    public function deleteStickerFromSet(
        ...
        return (bool) $this->sendRequest('deleteStickerFromSet', [
            'sticker' => $sticker
        ]);
    }
    ...
    public function getStickerSet(
        ...
        return new StickerSet($this->sendRequest('getStickerSet', [
            'name' => $name
        ]));
    }
    ...
    public function uploadStickerFile(
        ...
        return new File($this->sendRequest('uploadStickerFile', [
            'user_id' => $userId,
            'png_sticker' => $pngSticker,
        ]));
    }
    ...
    public function setChatStickerSet(
        ...
        return (bool) $this->sendRequest('setChatStickerSet', [
            'chat_id' => $chatId,
    ...
    public function deleteChatStickerSet(
        ...
        return (bool) $this->sendRequest('deleteChatStickerSet', [
            'chat_id' => $chatId,
        ]);
    }
    ...
    public function answerCallbackQuery(
        ...
        return (bool) $this->sendRequest('answerCallbackQuery', [
    ...
    public function answerInlineQuery(
        ...
        return (bool) $this->sendRequest('answerInlineQuery', [
    ...
    public function answerWebAppQuery(
        ...
        return new SentWebAppMessage($this->sendRequest('answerWebAppQuery', [
    ...
    public function answerPreCheckoutQuery(
        ...
        return (bool) $this->sendRequest('answerPreCheckoutQuery', [
    ...
    public function answerShippingQuery(
        ...
        return (bool) $this->sendRequest('answerShippingQuery', [
    ...
    public function getGameHighScores(
        ...
        return Utils::makeEntitiesArray(GameHighScore::class, $this->sendRequest('getGameHighScores', [
            'user_id' => $userId,
            'chat_id' => $chatId,
            'message_id' => $messageId,
            'inline_message_id' => ($chatId !== null || $messageId !== null) ? null : $inlineMessageId
    ...
    public function setGameScore(
        ...
        return $this->makeMessageOrBool($this->sendRequest('setGameScore', [
            'user_id' => $userId,
    ...
    {
        return new User($this->sendRequest('getMe'));
    }

    /**
     * Создает ссылку для счета-фактуры.
     *
    ...
    public function createInvoiceLink(
        ...
        return (string) $this->sendRequest('createInvoiceLink', [
            'title' => Utils::checkStr($title, 1, 32, true),
            'description' => Utils::checkStr($description, 1, 255, true),
            'payload' => $payload,
            'provider_token' => $providerToken,
    ...
    {
        return (bool) $this->sendRequest('logOut');
    }
    ...
    {
        return (bool) $this->sendRequest('close');
    }
    ...
    public function getUserProfilePhotos(
        ...
        return new UserProfilePhotos($this->sendRequest('getUserProfilePhotos', [
           'user_id' => $userId,
           'offset' => $offset,
    ...
    public function getMyCommands(
        ...
        return Utils::makeEntitiesArray(BotCommand::class, $this->sendRequest('getMyCommands', [
    ...
    public function setMyCommands(
        ...
        return (bool) $this->sendRequest('setMyCommands', [
    ...
    public function deleteMyCommands(
        ...
        return (bool) $this->sendRequest('deleteMyCommands', [
            'scope' => Utils::toJsonOrNull($scope),
            'language_code' => $languageCode
        ]);
    }
    ...
    public function getMyDefaultAdministratorRights(
        ...
        return new ChatAdministratorRights($this->sendRequest('getMyDefaultAdministratorRights', [
            'for_channels' => $forChannels
        ]));
    }

    /**
     * Изменяет права администратора по умолчанию,
    ...
    public function setMyDefaultAdministratorRights(
        ...
        return (bool) $this->sendRequest('setMyDefaultAdministratorRights', [
    ...
    public function getFile(
        ...
        return new File($this->sendRequest('getFile', [
            'file_id' => $fileId
        ]));
    }
    ...
    public function setPassportDataErrors(
        ...
        return (bool) $this->sendRequest('setPassportDataErrors', [
            'user_id,' => $userId,
